        ...
        <div className="w-full aspect-square relative bg-gradient-to-br from-gray-50 via-gray-100 to-gray-200 dark:from-gray-800 dark:via-gray-700 dark:to-gray-600 group overflow-hidden">
          {currentImage?.src ? (
            ...
            <div className="w-full h-full flex flex-col items-center justify-center animate-pulse">
              <div className="w-20 h-20 bg-gradient-to-br from-blue-100 to-blue-200 dark:from-blue-900 dark:to-blue-800 rounded-full flex items-center justify-center mb-4 shadow-lg">
                <Package className="w-10 h-10 text-blue-500 dark:text-blue-400" />
              </div>
              <p className="text-gray-600 dark:text-gray-300 font-semibold text-base tracking-wide">Bundle Produk</p>
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-2 text-center px-4 leading-relaxed">
        ...
        <div className="grid grid-cols-4 gap-3">
          {allImages.map((image, index) => (
            <button
              ...
              className={`
                relative aspect-square rounded-xl overflow-hidden border-2 transition-all duration-300 hover:shadow-lg transform hover:-translate-y-1
                ${selectedImage === index 
                  ? 'border-blue-500 ring-4 ring-blue-200 dark:ring-blue-800/50 shadow-lg scale-105' 
            ...
            >
              {image.src ? (
                ...
                <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-700 group hover:from-gray-200 hover:to-gray-300 dark:hover:from-gray-700 dark:hover:to-gray-600 transition-all duration-300">
                  <Package className="w-5 h-5 text-gray-400 dark:text-gray-500 group-hover:text-gray-600 dark:group-hover:text-gray-400 transition-colors duration-300" />
                </div>
              )}
              {index === 0 && (
                <div className="absolute top-1.5 left-1.5 bg-gradient-to-r from-blue-500 to-blue-600 text-white text-xs px-2 py-1 rounded-lg font-medium shadow-sm">
                  Utama
                </div>
              )}
            </button>
