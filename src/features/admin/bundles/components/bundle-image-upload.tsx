...
export function BundleImageUpload({
  value,
  onChange,
  className,
  disabled = false
  ...
  const handleFileSelect = async (file: File) => {
    ...
    try {
      ...
      setTimeout(() => {
        ...
        toast.success('Gambar paket berhasil diupload')
        ...
        >
          {isUploading ? (
            ...
            <div className="text-center space-y-3">
              ...
              <div className="space-y-1">
                <p className="text-sm font-medium text-gray-700">Upload Gambar Paket</p>
                <p className="text-xs text-gray-500">Klik untuk memilih file atau drag & drop</p>
              </div>
              <div className="text-xs text-gray-400 space-y-1">
                <p>Format: JPG, PNG, WebP</p>
                <p>Maksimal: 5MB</p>
                <p>Rekomendasi: 600x600px</p>
              </div>
            </div>
          )}
        </div>
