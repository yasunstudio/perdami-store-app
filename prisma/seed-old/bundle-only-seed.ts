...
async function seedUsers() {
  ...
  await prisma.user.upsert({
    where: { email: 'admin@perdami.store' },
    update: {},
    create: {
      email: 'admin@perdami.store',
      name: 'Admin Perdami',
      phone: '+6281234567890',
  ...
  await prisma.user.upsert({
    where: { email: 'customer@perdami.store' },
    update: {},
    create: {
      email: 'customer@perdami.store',
      name: 'Customer Test',
      phone: '+6281234567891',
  ...
  const actions = [
    {
      id: 'browse-bundles',
      title: 'Lihat Produk',
      description: 'Jelajahi produk bundle kami',
      icon: 'Package',
      action: '/products',
      color: 'blue',
